...
<ul>
  <li>ID: subject identifier (integer).</li>
  <li>TL: training load (sRPE - integer)</li>
  <li>weeks: week of training (integer).</li>
  <li>training_dates: date of the training (date format in excel - e.g. 7/1/22).</li>
</ul>
